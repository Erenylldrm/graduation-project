...
namespace ERPYAZİLİM
{
    ...
    public partial class Db_TıcarıOtomasyonEntities1 : DbContext
    {
        public Db_TıcarıOtomasyonEntities1()
            : base("name=Db_TıcarıOtomasyonEntities1")
        {
        }
        ...
        public virtual DbSet<YETKİLENDİRME> YETKİLENDİRME { get; set; }
        ...
        public virtual ObjectResult<makskategoriurun2_Result> makskategoriurun2()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<makskategoriurun2_Result>("makskategoriurun2");
        }
